...
try {
  ...
  console.log('  3. Restart OpenClaw gateway: openclaw gateway restart');
  console.log('  4. After first startup, write Cortex Memory rules to MEMORY.md');
  console.log('     (See SKILL.md or README.md for the content)');
  console.log('  5. To import existing memories, send:');
  console.log('     "Use sync_memory tool to import historical session memories"');
  console.log('');
